...
Global Const vbCr =  Chr(13)
Global Const vbCrLf =  Chr(13) & Chr(10)
Global Const vbLf =  Chr(10)
Global Const vbFormFeed =  Chr(10)
Global Const vbNewLine =  Chr(13) & Chr(10)
Global Const vbNullChar =  Chr(0)
Global Const vbTab =  Chr(9)
Global Const vbVerticalTab =  Chr(11)
